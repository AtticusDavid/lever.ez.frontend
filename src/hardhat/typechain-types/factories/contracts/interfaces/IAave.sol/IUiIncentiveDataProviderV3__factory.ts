...
} from "../../../../contracts/interfaces/IAave.sol/IUiIncentiveDataProviderV3";
  ...
  },
  {
    ...
    outputs: [
      ...
      },
      {
        ...
        internalType: "struct IUiIncentiveDataProviderV3.BaseCurrencyInfo",
        name: "",
        type: "tuple",
      },
    ],
...
export class IUiIncentiveDataProviderV3__factory {
  ...
  static createInterface(): IUiIncentiveDataProviderV3Interface {
    return new Interface(_abi) as IUiIncentiveDataProviderV3Interface;
  }
  static connect(
    address: string,
