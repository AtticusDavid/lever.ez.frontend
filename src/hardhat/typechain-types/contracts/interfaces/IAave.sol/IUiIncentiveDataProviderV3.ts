...
export interface IUiIncentiveDataProviderV3Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IUiIncentiveDataProviderV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IUiIncentiveDataProviderV3;
  ...
  getReservesData: TypedContractMethod<
    ...
    [
      [
        IUiIncentiveDataProviderV3.AggregatedReserveIncentiveDataStructOutput[],
        IUiIncentiveDataProviderV3.BaseCurrencyInfoStructOutput
      ]
    ],
    "view"
  >;
