...
export interface LeveragerInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "dstToLeverager",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface Leverager extends BaseContract {
  ...
  addDstChain: TypedContractMethod<
    [destChainSelector: BigNumberish, leverager: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  dstToLeverager: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "dstToLeverager"
